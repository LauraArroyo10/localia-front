		...
		<section className="w-full bg-white py-16 px-6 flex flex-col items-center">
			<div className="w-full max-w-[1200px]">
				...
				<div className="flex justify-between items-center mb-10 w-full max-w-[1200px]">
					<h2 className="text-3xl font-bold text-[#1F294E]">
				...
				<div className="relative flex gap-6 overflow-x-auto pb-4 scrollbar-none w-full">
					{cards.map((_, index) => (
						<div
							key={index}
							className="flex-1 min-w-[260px] bg-white rounded-3xl overflow-hidden p-4 flex flex-col gap-3"
						>
							<img
								src={destinationImg}
								alt="Destination"
							...
							/>
							<span className="text-[#4D55C8] font-semibold text-sm px-1">
								Location
							</span>
